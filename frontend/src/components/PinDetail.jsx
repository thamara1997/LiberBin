...
const MainPinDetail = ({ user }) => {
  ...
  if (!pinDetail) return <Spinner msg={"Loading Review"} />;
  return (
    <>
      <div
        className="flex xl:flex-row flex-col m-auto bg-white p-8"
        style={{ maxWidth: "1500px", borderRadius: "35px" }}
      >
        {/* image */}
        <div className="flex justify-center items-center md:items-start flex-initial m-3 ">
          <img
        ...
        {/* pin details */}
        <div className="w-full p-4 pt-1 flex-1 ">
          ...
          <div className="text-left">
            ...
            <p className="mt-8 text-justify italic">{pinDetail.about}</p>
          </div>
          {/* user detail */}
          <Link
          ...
          {/* comments */}
          <h2 className="mt-9 text-2xl">Comments</h2>
      ...
      {pins?.length > 0 ? (
        ...
        <Spinner msg={"Loading More Reviews"} />
      )}
    </>
  );
};
