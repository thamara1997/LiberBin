...
import shareVideo from '../assets/watchme.mp4'
      ...
      <div className="absolute flex flex-col justify-center items-center top-0 right-0 left-0 bottom-0 ">
        ...
        <div className="shadow-2x1 ">{/*
          <GoogleLogin
            ...
            <button
                type="button"
                className="bg-mainColor bg-transparent flex justify-center items-center p-2 rounded-lg cursor-pointer outline outline-teal-800 transform hover:scale-105 motion-reduce:transform-none"
                onClick={signIn}
              >
                <FcGoogle className="mr-2 ml-2"/>
                <div className="text-white mr-2">Click Here </div>
            </button>
        </div>
      </div>
    </div>
